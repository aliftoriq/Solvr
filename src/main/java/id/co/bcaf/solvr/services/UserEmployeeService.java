...
public class UserEmployeeService {
    ...
    public UserEmployeeResponse updateUserEmployee(UUID userEmployeeId, UserEmployeeRequest userEmployeeRequest) {
        UserEmployee userEmployee = userEmployeeRepository.findById(userEmployeeId).orElseThrow(() -> new IllegalArgumentException("UserEmployee not found"));
